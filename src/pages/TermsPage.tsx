  ...
  return (
    <div style={{ maxWidth: '720px', margin: '0 auto', padding: '2rem 1.5rem', color: 'var(--fg)', fontFamily: 'var(--font-display)' }}>
      ...
      <div style={{ fontSize: '0.8rem', lineHeight: 1.7, opacity: 0.85 }}>
        ...
        <p style={{ marginBottom: '1rem' }}>By using Glyph, you agree to these terms. If you do not agree, please do not use the service.</p>
        <h2 style={{ fontSize: '0.9rem', fontWeight: 600, marginTop: '1.5rem', marginBottom: '0.5rem' }}>2. Service</h2>
        <p style={{ marginBottom: '1rem' }}>Glyph is a client-side ASCII art generator. All processing happens in your browser. No data is sent to any server.</p>
        <h2 style={{ fontSize: '0.9rem', fontWeight: 600, marginTop: '1.5rem', marginBottom: '0.5rem' }}>3. Content</h2>
        <p style={{ marginBottom: '1rem' }}>You retain all rights to images and content you create using Glyph. We do not store, collect, or have access to your content.</p>
        ...
        <p style={{ marginBottom: '1rem' }}>Glyph is provided "as is" without warranty. We are not liable for any loss of data or content.</p>
