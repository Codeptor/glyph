  ...
  return (
    <div style={{ maxWidth: '720px', margin: '0 auto', padding: '2rem 1.5rem', color: 'var(--fg)', fontFamily: 'var(--font-display)' }}>
      ...
      <div style={{ fontSize: '0.8rem', lineHeight: 1.7, opacity: 0.85 }}>
        ...
        <p style={{ marginBottom: '1rem' }}>Glyph does not collect, store, or transmit any personal data. The application runs entirely in your browser.</p>
        ...
        <p style={{ marginBottom: '1rem' }}>Glyph does not use cookies or any tracking technologies.</p>
